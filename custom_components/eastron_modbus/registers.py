...
SDM120_REGISTERS: tuple[EastronRegister, ...] = (
    ...
    _w("active_power", "Active power", 12),
    _va("apparent_power", "Apparent power", 18),
    _var("reactive_power", "Reactive power", 24),
    ...
    _kwh("import_active_energy", "Import active energy", 72),
    ...
    _kwh("total_active_energy", "Total active energy", 342),
    _kvarh("total_reactive_energy", "Total reactive energy", 344),
)
...
SDM630_REGISTERS: tuple[EastronRegister, ...] = (
    ...
    _w("active_power_l1", "Active power L1", 12),
    _w("active_power_l2", "Active power L2", 14),
    _w("active_power_l3", "Active power L3", 16),
    _va("apparent_power_l1", "Apparent power L1", 18),
    _va("apparent_power_l2", "Apparent power L2", 20),
    _va("apparent_power_l3", "Apparent power L3", 22),
    _var("reactive_power_l1", "Reactive power L1", 24),
    _var("reactive_power_l2", "Reactive power L2", 26),
    _var("reactive_power_l3", "Reactive power L3", 28),
    ...
    _a("current_sum", "Sum of line currents", 48),
    _w("total_active_power", "Total active power", 52),
    _va("total_apparent_power", "Total apparent power", 56),
    _var("total_reactive_power", "Total reactive power", 60),
    ...
    _v("voltage_l1_l2", "Voltage L1-L2", 200),
    _v("voltage_l2_l3", "Voltage L2-L3", 202),
    _v("voltage_l3_l1", "Voltage L3-L1", 204),
    _v("voltage_ll_avg", "Average voltage L-L", 206),
    _a("neutral_current", "Neutral current", 224),
