...
SDM120_REGISTERS: tuple[EastronRegister, ...] = (
    ...
    _kwh("import_energy", "Import energy", 72),
    _kwh("export_energy", "Export energy", 74),
    ...
    _w("total_system_power_demand", "Total system power demand", 84, enabled_default=False),
    _w("maximum_total_system_power_demand", "Maximum total system power demand", 86, enabled_default=False),
    _w("import_system_power_demand", "Import system power demand", 88, enabled_default=False),
    _a("current_demand", "Current demand", 258, enabled_default=False),
    _a("maximum_current_demand", "Maximum current demand", 264, enabled_default=False),
...
SDM630_REGISTERS: tuple[EastronRegister, ...] = (
    ...
    _w("power_l1", "Power L1", 12),
    _w("power_l2", "Power L2", 14),
    _w("power_l3", "Power L3", 16),
    ...
    # System totals
    _v("average_voltage_l_n", "Average voltage L-N", 42),
    _a("average_current", "Average current", 46),
    _a("sum_of_line_currents", "Sum of line currents", 48, enabled_default=False),
    _w("total_power", "Total power", 52),
    ...
    _v("average_voltage_l_l", "Average voltage L-L", 206, enabled_default=False),
    ...
    _thd("average_voltage_thd", "Average voltage THD", 248),
    _thd("average_current_thd", "Average current THD", 250),
    # Per-phase demand
